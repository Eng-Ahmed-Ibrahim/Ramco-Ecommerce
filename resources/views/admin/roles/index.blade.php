                ...
                @can('roles-create')
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <a class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_add_role">Add New</a>
                    </div>
                @endcan
            </div>
        </div>
                            ...
                            <table class="table align-middle gs-0 gy-4">
                                <thead>
                                    <tr class="fw-bold text-muted bg-light">
                                        ...
                                        <th class="ps-4 min-w-125px">Name</th>
                                        {{-- @if ($current_user->can('edit roles') || $current_user->can('delete roles')) --}}
                                                ...
                                                <td class="text-center d-flex gap-2 justify-content-center">
                                                    ...
                                                    @can('roles-delete')
                                                        <form action="{{ route('admin.roles.delete', $role->id) }}"
                                                            ...
                                                            @method('DELETE')
                                                            <button type="submit"
                                                                class="btn btn-bg-light btn-color-muted btn-active-color-danger btn-sm px-4">Delete</button>
                                                        </form>
                                                    @endcan
                                                </td>
                                            {{-- @endif --}}
            ...
            <div class="modal-dialog modal-fullscreen">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-lg-5 my-7">
                        <!--begin::Form-->
                        <form id="kt_modal_add_role_form" action="{{ route('admin.roles.store') }}"
                            class="form form-ajax fv-plugins-bootstrap5 fv-plugins-framework" method="post">
                            @csrf
                            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_role_scroll"
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" placeholder="Enter role name"
                                ...
                                <div class="fv-row">
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5">
                                        ...
                                        <tbody class="text-gray-600 fw-semibold">
                                            <!--begin::Table row-->
                                            <tr>
                                                <td class="text-gray-800">Administrator Access <i
                                                    ...
                                                    @foreach ($permissions as $setionName => $permissions)
                                                        ...
                                                        @foreach ($permissions as $permission)
                                                            <label class="col-4 mb-2">
                                                                <input class="form-check-input permissions"
                                                                    type="checkbox" value="{{ $permission->name }}"
                                                                    name="permissions[]">
                                                                <span class="form-check-label fw-bold">
                                                                    {{ str_replace("$setionName-"," ",$permission->name) }}
